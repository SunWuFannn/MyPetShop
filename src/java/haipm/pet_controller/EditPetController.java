...
public class EditPetController extends HttpServlet {
    private static final String SUCCESS = "Pet/editPet.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean.setPetID(petID);
            PetDTO pet = bean.finByPK();
            request.setAttribute("PET_EDIT", pet);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at EditPetController : " +e.getMessage());
        }
        finally{
