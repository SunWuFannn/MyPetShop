 ...
 * @author 99hai
 */
public class SearchAccessoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<AccessoryDTO> mylist = (ArrayList<AccessoryDTO>)bean.search();
            if(mylist.size() >0 ){
                request.setAttribute("LIST_ACCESSORY", mylist);
            }
        } catch (Exception e) {
            log("Error at SearchAccessoryController : " +e.getMessage());
        }
        finally{
