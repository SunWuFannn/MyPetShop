...
public class AdminSearchOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean.setDateSearch(date);
            ArrayList<OrderDTO> listOrder = (ArrayList<OrderDTO>) bean.searchOrder();
            if (listOrder != null) {
                ...
                request.setAttribute("ERROR", "search Falied");
            }
        } catch (Exception e) {
            log("Error at AdminSearchOrder Controller : " + e.getMessage());
        } finally {
