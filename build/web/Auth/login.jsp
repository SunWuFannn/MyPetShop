<%-- 
    Document   : login
    Created on : Jun 13, 2019, 3:05:27 PM
    Author     : 99hai
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/Auth/CSS/login_css.css">
    </head>
    ...
    <body>
        <div class="container-login">
            <div class="myform">
                ...
                <form action="/PETWATER/MainController" method="POST">
