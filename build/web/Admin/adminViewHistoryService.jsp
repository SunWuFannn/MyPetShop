<%-- 
    Document   : adminViewHistoryService
    Created on : Jun 23, 2019, 12:36:43 PM
    Author     : 99hai
--%>
                        ...
                        <div class="card-body">
                            <c:if test="${requestScope.LIST_HISTORY != null}">
                                <table class="table table-bordered table-hover myTable">
                                    ...
                                    <c:forEach items="${requestScope.LIST_HISTORY}" var="process">
                                        <tr>
                        ...
                        <div class="card-footer myCardFooter">
                            <ul class="pagination">
                                <c:forEach var="i" begin="1" end="${requestScope.NUMBER_PAGE}" step="1">
                                    <li class="page-item"><a class="page-link" href="AdminManageHistoryService?idPage=${i}">${i}</a></li>
                                    </c:forEach>
                            </ul>
                        </div>
                    </div>
