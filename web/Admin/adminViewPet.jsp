<%-- 
    Document   : adminViewPet
    Created on : Jun 18, 2019, 9:51:04 AM
    Author     : 99hai
--%>
                                ...
                                <table class="table table-bordered table-hover myTable">
                                    ...
                                    <c:forEach items="${requestScope.LIST_PET}" var="pet">
                                        <tr>
                                            ...
                                            <td>${pet.petType}</td>
                                            <td>${pet.owner}</td>
                                            <td><img src="Image-Pet/${pet.petImage}" style="width: 150px; height: 100px"></td>
                                            <td><span style="height: 20px" class="badge badge-<c:if test='${pet.isActive}'>success</c:if><c:if test='${!pet.isActive}'>danger</c:if>" style="width: 100px;">
                                                    <c:if test='${pet.isActive}'>Active</c:if><c:if test='${!pet.isActive}'>Block</c:if>
                                                    </span></td>
                                            </tr>
                                    </c:forEach>
                                </table>
